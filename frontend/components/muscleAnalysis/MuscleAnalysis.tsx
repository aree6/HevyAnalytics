...
import { computeWeeklySetsDelta, computeWeeklySetsSummary } from './weeklySetsMetrics';
...
export const MuscleAnalysis: React.FC<MuscleAnalysisProps> = ({
  ...
  const windowedSelectionBreakdown = useMemo(() => {
    ...
    return computeWindowedExerciseBreakdown({
      ...
      grouping,
      selectedSubjects: selectedSubjectKeys,
    });
      ...
      <div className="grid gap-2 grid-cols-1 lg:grid-cols-2">
        ...
        <div className="bg-black/70 rounded-xl border border-slate-700/50 p-4 relative">
          ...
          <div className="absolute top-3 left-3 right-3 z-10 flex items-center justify-between">
            ...
            <div className="inline-flex bg-black/70 rounded-lg p-0.5 shadow-lg">
              <button
          ...
          <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-10">
            <div className="flex items-center gap-3 text-xs text-slate-400 bg-slate-950/75 rounded-lg px-3 py-1.5">
              <div className="flex items-center gap-1">
                <div className="w-3 h-2 rounded" style={{ backgroundColor: 'rgb(var(--tint-rgb) / 0.06)' }}></div>
                <span>None</span>
              </div>
              <div className="flex items-center gap-1">
        ...
        <div className="bg-black/70 rounded-xl border border-slate-700/50 overflow-hidden">
          ...
          {windowedSelectionBreakdown && (
            <div className="border-t border-slate-800/30">
              ...
              <div className="overflow-y-auto max-h-[calc(100vh-400px)] px-4 pb-4 mt-2 scroll-smooth">
