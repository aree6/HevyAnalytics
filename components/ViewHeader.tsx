...
export const ViewHeader: React.FC<ViewHeaderProps> = ({
  ...
  return (
    <div className="bg-black/70 p-3 sm:p-4 rounded-xl border border-slate-700/50">
      <div className="grid grid-cols-1 sm:grid-cols-[auto,1fr,auto] items-center gap-3">
        {/* Left: Stats */}
        <div className="hidden sm:flex items-center gap-2 justify-start">
          {stats.map((stat, i) => (
            <div key={i} className="flex items-center gap-2 px-3 py-2 bg-black/70 border border-slate-700/50 rounded-lg">
